...
title: "User Interface Component: Dual Layer Slider"
...
> [View the code on GitHub.](https://github.com/markadrake/web-ui-sequenced-content)
...
1. Simultaneously - we have the opportunity to present media in the background to grab our user's attention, drive some sort of emotion, even aid the user's understanding.
1. Moving the background image and the text at the same time had some visual appeal to me and just looked like this would be a fun exercise!
